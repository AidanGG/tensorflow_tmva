...
# Gets TTrees from ROOT files.
signal_file = ROOT.TFile("ROOT_data/signal.root")
continuum_file = ROOT.TFile("ROOT_data/continuum.root")
signal_tree = signal_file.Get("h101;1")
continuum_tree = continuum_file.Get("h101;1")

# Stores TTrees in our data structure.
